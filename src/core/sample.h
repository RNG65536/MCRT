...
vec3 sampleSolidAngleUniform(float x, float y, float cos_theta_min, float *pdf = nullptr);
...
vec3 sampleHemisphereCosinePowerW(float x, float y, float power, float *pdfW = nullptr);
